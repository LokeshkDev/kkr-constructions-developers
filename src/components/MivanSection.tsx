...
export const MivanSection: React.FC = () => {
  ...
  return (
    <section id="mivan" className="py-24 bg-brand-charcoal text-white relative overflow-hidden architectural-grid-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {MIVAN_HIGHLIGHTS.stats.map((stat, idx) => (
            <div 
              key={idx}
              className="p-8 rounded-xl bg-gradient-to-br from-white/10 to-white/5 border border-white/15 hover:border-brand-green/60 transition-all group"
            >
        ...
        <div className="bg-brand-darkSlate rounded-2xl p-8 border border-white/10 shadow-2xl">
          ...
          {activeTab === 'mivan' ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 rounded-xl bg-brand-green/10 border border-brand-green/30">
              <div className="space-y-2">
                <div className="text-xs font-bold text-brand-green uppercase tracking-wider">Speed &amp; Cycle</div>
                <div className="text-lg font-bold text-white">7–10 Days / Floor</div>
              ...
              <div className="space-y-2">
                ...
                <div className="text-lg font-bold text-white">Monolithic &amp; Smooth</div>
              ...
              <div className="space-y-2">
                ...
                <div className="text-lg font-bold text-white">Superior Box Structure</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 rounded-xl bg-amber-950/30 border border-amber-500/20">
              <div className="space-y-2">
                <div className="text-xs font-bold text-amber-400 uppercase tracking-wider">Speed &amp; Cycle</div>
                <div className="text-lg font-bold text-white">20–25 Days / Floor</div>
              ...
              <div className="space-y-2">
                ...
                <div className="text-lg font-bold text-white">Rough Masonry</div>
              ...
              <div className="space-y-2">
                ...
                <div className="text-lg font-bold text-white">Masonry Joints</div>
