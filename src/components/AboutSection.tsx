      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center mb-12 sm:mb-16">
          ...
          >
            ...
            <div className="p-5 sm:p-6 rounded-[4px] bg-brand-lightGreen/60 border border-brand-green/30 space-y-2.5 shadow-sm hover:shadow-md transition-shadow">
          ...
          {/* Right Column: Authentic Office Headquarters Image Card */}
          <motion.div 
            initial={{ opacity: 0, y: 25 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="relative rounded-[4px] overflow-hidden shadow-2xl border border-gray-200 group">
              <img 
                ...
                loading="lazy"
                decoding="async"
                className="w-full h-[380px] sm:h-[440px] lg:h-[480px] object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-out"
              />
              ...
              >
                <div className="space-y-3.5">
                  ...
                  <div>
                    ...
                    <div className="inline-block mt-2 px-2.5 py-0.5 rounded-[4px] bg-brand-lightGreen text-brand-green text-[11px] font-bold border border-brand-green/20">
                      {member.experience}
                    </div>
                  </div>
